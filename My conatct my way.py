...
root.title('Your Contacts, Your Way')
root.resizable(0,0)
contactlist = [
    ...
    ['Anaya Singh', '521155222'],
    ['Tripti Sharma', '78945614'],
    ['Ansh Singh', '58745246'],
    ['Mohit Yadav', '5846975'],
    ['Kiran Patel', '5647892'],
    ['Sameer Sharma', '89685320'],
    ['Jaydeep Maheshwari', '98564785'],
    ['Ganesh Verma','85967412']
    ]
...
#define function to get select value
...
# define function to edit existing contact
...
#define function to delete selected contact
def Delete_Entry():
    if len(select.curselection())!=0:
...
# define function to view contact
def VIEW():
...
#define function to exit game window   
def EXIT():
    root.destroy()
...
Button(root,text=" ADD", font='Helvetica 18 bold',bg='light pink', command = AddContact, padx=20). place(x= 50, y=140)
Button(root,text="EDIT", font='Helvetica 18 bold',bg='light pink',command = UpdateDetail, padx=20).place(x= 50, y=200)
Button(root,text="DELETE", font='Helvetica 18 bold',bg='light pink',command = Delete_Entry, padx=20).place(x= 50, y=260)
Button(root,text="VIEW", font='Helvetica 18 bold',bg='light pink', command = VIEW).place(x= 50, y=325)
Button(root,text="RESET", font='Helvetica 18 bold',bg='light pink', command = EntryReset).place(x= 50, y=390)
Button(root,text="EXIT", font='Helvetica 24 bold',bg='light pink', command = EXIT).place(x= 250, y=470)
